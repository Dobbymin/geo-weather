...
export const FavoritesList = () => {
  const FAVORITES_DATA_MOCK: { 
    ...
    { id: "suwon-yeongtong", name: "경기도 수원시 영통구", temp: 24, status: "RAIN", condition: "흐리고 비", high: 26, low: 18 },
    { id: "jeju-city", name: "제주특별자치도 제주시", temp: 21, status: "CLOUDY", condition: "구름 많음", high: 22, low: 20 },
    { id: "busan-haeundae", name: "부산광역시 해운대구", temp: 18, status: "PARTLY_CLOUDY", condition: "구름 조금", high: 20, low: 15 },
    ...
    { id: "daejeon-seogu", name: "대전광역시 서구", temp: 13, status: "THUNDERSTORM", condition: "천둥번개", high: 15, low: 9 },
  ];
